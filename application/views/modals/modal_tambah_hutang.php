...
<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Tambah Data Hutang</h3>

  <form id="form-tambah-hutang" method="POST">
    ...
    <?php 
    foreach ($this->M_hutang->last_record() as $row) {
      $kode = $row->Kode;
      $convKode = (int)$kode+1;
     ?>
...
?>
    ...
    <div class="form-group">
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right" id="tgl_hutang" placeholder="Tanggal Hutang" name="tanggal">
                    </div>
                     
                  </div>
<script>
$(function() {
   $("#tgl_hutang").datepicker({
       autoclose: true,
         format: "yyyy-mm-dd",
         todayHighlight: true,
  ...
  <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Hutang" name="hutang" aria-describedby="sizing-addon2">
    </div>
 ...
 <!-- <div class="input-group form-group">
    ...
    <div class="form-group">
      <div class="col-md-12">
          <button type="submit" class="form-control btn btn-primary" onClick="window.location.reload('hutang/home')"> <i class="glyphicon glyphicon-ok"></i> Tambah Data</button>
      </div>
    </div>
  </form>
</div>
