<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-update-supplier" method="POST">
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Nama" name="nama" aria-describedby="sizing-addon2" value="<?php echo $dataSupplier->Nama; ?>">
    </div>
  ...
  <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Kota" name="kota" aria-describedby="sizing-addon2" value="<?php echo $dataSupplier->Kota; ?>">
      </div>
      ...
      <input type="text" class="form-control" placeholder="Telepon" name="telepon" aria-describedby="sizing-addon2" value="<?php echo $dataSupplier->Telepon; ?>">
      </div>
