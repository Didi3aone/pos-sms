...
<div class="box">
  <div class="box-header">
    ...
    <form id="myForm" action="" method="post" name='frmPenjualan'>
      <button class="btn btn btn-info pull-right" type="button" ><i class="glyphicon glyphicon-info-sign"></i> Posisi Piutang</button>
...
todayHighlight: true,
    ...
    <div class="table-responsive" style="height:250px; overflow:auto;" id="responsecontainer">
        ...
        var loopingNo = document.getElementById("no");
            ...
            <?php
              ...
              foreach ($dataTemp as $temp) {
                ...
                var nO=document.forms['inputTabel']['no'].value;
                var kodeJual=document.forms['inputTabel']['kode_jual'].value;
                var namaBarang=document.forms['inputTabel']['nama_barang'].value;
                var qTy=document.forms['inputTabel']['qty'].value;
                var sAtuan=document.forms['inputTabel']['satuan'].value;
                var hArga=document.forms['inputTabel']['harga'].value;
                var dIsc1=document.forms['inputTabel']['disc_1'].value;
                var dIsc2=document.forms['inputTabel']['disc_2'].value;
                var dIsc3=document.forms['inputTabel']['disc_3'].value;
                var jUmlah=document.forms['inputTabel']['jumlah'].value;
                var bNs=document.forms['inputTabel']['bns'].value;
                var gUdang=document.forms['inputTabel']['gudang'].value;
...
<?php if($dataSTotal[0]->s_total > NULL && $dataDiskon > NULL) { echo $dataTotal; } elseif($dataSTotal[0]->s_total > NULL && $dataDiskon == NULL) { echo $dataSTotal[0]->s_total; } else echo "0"; ?>
